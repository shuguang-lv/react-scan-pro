  ...
  return (
    <div className="mx-auto max-w-xl">
      <div className="mt-8 space-y-6">
        <div>
          <span className="font-bold">Replay for React Scan Pro</span> saves clips of your website
          when performance drops, and provides a breakdown of what happened
        </div>
        ...
        <div className="relative">
          ...
          <div
            className={`absolute inset-x-0 -top-12 transition-all duration-500 ${showSuccess ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}
          >
          ...
          <div
            className={`absolute inset-x-0 -top-12 transition-all duration-500 ${showError ? "opacity-100 translate-y-0" : "opacity-0 translate-y-2"}`}
          >
            <div className="flex items-center justify-center">
                ...
                <div className="absolute inset-0">
                  ...
                  <div className="absolute inset-0 w-full h-full flex items-center justify-center">
                    <div className="h-16 w-16 rounded-full bg-white/90 backdrop-blur-sm shadow-lg flex items-center justify-center transform group-hover:scale-105 transition-all duration-300 group-hover:bg-white">
                      <svg
                        className="w-7 h-7 text-gray-900 relative left-0.5"
                        fill="currentColor"
                        viewBox="0 0 24 24"
                      >
